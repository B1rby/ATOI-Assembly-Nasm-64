...
_printinteger:
    ...
    mov [rcx], rbx                  ; rcx is pointing into rbx 
...
; after that we finish to convert our digits into character. The problem it's that the value isn't to the correct. For example if we have put
